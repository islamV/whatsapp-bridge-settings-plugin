...
return [
    ...
    'page_subheading' => 'تكوين مزودي الخدمة، الاتصالات وإعدادات الرسائل.',
    ...
    'bridge' => [
        ...
        'whatsapp_title' => 'جلسة واتساب',
        'instance_title' => 'المثيل',
        'active_instance' => 'المثيل النشط',
        'no_instance' => '—',
        'active_session' => 'جلسة نشطة',
        'no_session' => 'لا توجد جلسة نشطة',
        'scan_qr_hint' => 'امسح رمز QR للاتصال',
        'latency_label' => ':ms م.ث الاستجابة',
        'save_changes' => 'حفظ التغييرات',
        'request_timeout' => 'مهلة الطلب',
        'timeout_suffix' => 'ثانية',
        'bridge_unreachable_title' => 'تعذر الوصول إلى خدمة الجسر',
        'bridge_unreachable_body' => 'تأكد من تشغيل خدمة الجسر (Node.js) وإمكانية الوصول إليها عبر الرابط المحدد.',
        'send_test_disabled_tooltip' => 'قم بربط واتساب أولاً قبل إرسال رسالة اختبار.',
    ],
    ...
    'notifications' => [
        ...
        'qr_failed' => 'فشل توليد رمز QR. تحقق من إعدادات الجسر واستجابة الخدمة.',
    ],
